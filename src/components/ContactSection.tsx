...
export const ContactSection: React.FC<ContactSectionProps> = ({ currentLanguage }) => {
  ...
  return (
    <section id="contact" className="tesla-section bg-white">
      <div className="tesla-container">
        ...
        <div className="text-center mb-24">
          ...
          <p className="text-xl tesla-subheading max-w-4xl mx-auto text-pretty">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="animate-slide-in space-y-8">
            <h3 className="text-2xl tesla-heading mb-8">{t.contact.info.title}</h3>
            
            {/* Phone */}
            <div className="tesla-card hover-lift p-6">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-premium-blue rounded-tesla flex items-center justify-center mr-4">
                  <Phone className="tesla-icon-white" />
                </div>
                <div className="flex-1">
                  <h4 className="font-medium tesla-heading mb-1">{t.contact.info.phone.label}</h4>
                  <p className="tesla-subheading text-sm">Direct line to our investment experts</p>
                </div>
              </div>
              <a 
                href={`tel:${t.contact.info.phone.value}`} 
                className="tesla-btn-primary w-full group"
                onClick={() => {
            ...
            <div className="tesla-card hover-lift p-6">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-premium-blue rounded-tesla flex items-center justify-center mr-4">
                  <Mail className="tesla-icon-white" />
                </div>
                <div className="flex-1">
                  <h4 className="font-medium tesla-heading mb-1">{t.contact.info.email.label}</h4>
                  <p className="tesla-subheading text-sm">Get detailed investment information</p>
                </div>
              </div>
              <a 
                href={`mailto:${t.contact.info.email.value}`} 
                className="tesla-btn-secondary w-full group"
                onClick={() => {
                  if (typeof gtag !== 'undefined') {
            ...
            <div className="tesla-card hover-lift p-6">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-green-600 rounded-tesla flex items-center justify-center mr-4">
                  <MessageCircle className="tesla-icon-white" />
                </div>
                <div className="flex-1">
                  <h4 className="font-medium tesla-heading mb-1">WhatsApp Gabriella</h4>
                  <p className="tesla-subheading text-sm">Instant messaging with our CEO</p>
                </div>
              </div>
              <a 
                ...
                className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-tesla font-medium text-sm tracking-wide transition-all duration-400 hover-lift w-full text-center group flex items-center justify-center"
                onClick={() => {
                  if (typeof gtag !== 'undefined') {
              ...
              >
                <span>{t.contact.whatsapp.gabriella}</span>
                <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
              </a>
            </div>

            {/* Company Info */}
            <div className="bg-deep-gray rounded-tesla-lg p-8 text-white">
              <div className="flex items-center mb-6">
                ...
                <div className="ml-3 flex flex-col justify-center h-6">
                  <div className="text-white font-inter font-bold text-xs tracking-wider leading-tight text-premium-blue">
                    <div className="uppercase font-bold">PALM</div>
                    <div className="uppercase font-bold">SIGNATURE</div>
                  </div>
                </div>
              </div>
              <p className="text-white/80 mb-6 font-light leading-relaxed">{t.contact.about.description}</p>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-premium-blue hover:text-white font-medium transition-colors duration-400"
              >
          ...
          <div className="animate-fade-in-up">
            <div className="tesla-card p-8 lg:p-12">
              <h3 className="text-2xl tesla-heading mb-8 text-center">
                {t.contact.form.title}
              </h3>
              
              <div className="w-full rounded-tesla overflow-hidden" style={{ minHeight: '404px' }}>
                <iframe
                  ...
                  className="w-full rounded-tesla"
                  style={{ 
                    border: 'none',
                    minHeight: '404px',
