            ...
            <div className="space-y-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div className="tesla-subheading">
                    <a href={`tel:${t.contact.info.phone.value}`} className="hover:text-black">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div className="tesla-subheading">
                    <a href={`mailto:${t.contact.info.email.value}`} className="hover:text-black">
