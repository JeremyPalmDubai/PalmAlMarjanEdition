          ...
          <div className="h-[70vh] min-h-[600px] relative overflow-hidden bg-black">
            <picture>
              ...
              <img
                ...
                alt="Al Marjan Island four coral islands aerial view with luxury developments and beaches"
                title="Al Marjan Island Real Estate - Four Coral Islands Investment Destination"
                className="w-full h-full object-cover"
                width="1920"
                height="1080"
                loading="lazy"
                decoding="async"
                data-seo-filename="al-marjan-island-four-coral-islands-aerial-luxury-developments.webp"
              />
            </picture>
        ...
        <div className="tesla-container">
          ...
          <div className="grid md:grid-cols-3 gap-16 mb-32">
            <div className="text-center">
              ...
              <h3 className="text-xl font-inter font-light mb-6 tracking-tight">Wynn Resort Proximity</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-inter font-light mb-6 tracking-tight">Freehold Ownership</h3>
              <p className="text-gray-300 font-light leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-inter font-light mb-6 tracking-tight">Family-Friendly Living</h3>
              <p className="text-gray-300 font-light leading-relaxed">
          ...
          {/* Tesla-style centered tagline */}
          <div className="text-center mb-32">
            <h3 className="text-2xl md:text-3xl font-inter font-light mb-8 tracking-tight">
              Choose <strong>high-ROI properties in Al Marjan Island</strong> for the area's developed resort infrastructure
            </h3>
          </div>

          {/* Tesla-style 2-column layout */}
          <div className="grid lg:grid-cols-2 gap-24 mb-32">
            <div>
              <div className="space-y-8">
                <div className="border-b border-gray-800 pb-6">
                  <div className="text-white font-light mb-2">Family entertainment facilities</div>
                  <div className="text-gray-400 text-sm font-light">Water park near Hilton hotel</div>
                </div>
                <div className="border-b border-gray-800 pb-6">
                  <div className="text-white font-light mb-2">Marine activities and recreation</div>
                  <div className="text-gray-400 text-sm font-light">Water sports complexes</div>
                </div>
                <div className="border-b border-gray-800 pb-6">
                  <div className="text-white font-light mb-2">Landscaped outdoor spaces</div>
                  <div className="text-gray-400 text-sm font-light">Green walking routes and parks</div>
                </div>
                <div className="border-b border-gray-800 pb-6">
                  <div className="text-white font-light mb-2">Diverse dining and entertainment</div>
                  <div className="text-gray-400 text-sm font-light">Bars, restaurants, cafes</div>
                </div>
                <div>
                  <div className="text-white font-light mb-2">Pristine coastline access</div>
                  <div className="text-gray-400 text-sm font-light">8 km of well-maintained beaches</div>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="bg-white text-black p-8 mb-8">
                <h4 className="text-lg font-medium mb-6">Major Developments</h4>
                <div className="space-y-4">
                  <div className="flex items-center justify-between border-b border-gray-200 pb-4">
                    <span className="text-gray-600 font-light">Wynn Al Marjan Island Resort</span>
                    <span className="text-sm font-medium">2027</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600 font-light">Marina for 300 yachts</span>
              ...
              <div className="bg-gray-900 text-white p-8">
                <h4 className="text-lg font-light mb-4">Existing Amenities</h4>
