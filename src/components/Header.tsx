...
export const Header: React.FC<HeaderProps> = ({ currentLanguage, onLanguageChange }) => {
  ...
  return (
    <header className={`nav-minimal transition-all duration-500 ease-in-out ${
      isVisible 
        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center cursor-pointer" onClick={handleLogoClick}>
            ...
            <div className="ml-3 flex flex-col justify-center h-6 hidden sm:flex">
              <div className="text-[#1d1d1f] font-inter font-semibold text-xs tracking-wider leading-tight">
            ...
            <div className="ml-3 sm:ml-4 md:ml-6">
              {/* Mobile version */}
              <div className="sm:hidden text-[#1d1d1f] font-inter font-semibold text-xs tracking-wider uppercase leading-tight">
                <div>AL MARJAN</div>
                <div>ISLAND</div>
              </div>
              {/* Desktop version */}
              <div className="hidden sm:block glass-dark px-4 py-2 text-white rounded-xl text-xs font-medium tracking-wider">
