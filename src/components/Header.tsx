        ...
        <div className="sm:hidden py-2">
          ...
          <div className="flex justify-center">
            <a
              href="#contact"
              onClick={handleContactClick}
              className="bg-black text-white px-6 py-2 rounded-full font-semibold text-xs tracking-wide hover:bg-gray-800 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-black w-full text-center"
              aria-label="Contact us for investment opportunities"
            >
              {t.navigation.contact}
            </a>
