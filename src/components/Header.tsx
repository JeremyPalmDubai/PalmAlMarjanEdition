        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center cursor-pointer" onClick={handleLogoClick}>
            ...
            <div className="ml-4 flex items-center">
              <div className="hidden sm:flex flex-col justify-center h-6 mr-4">
              ...
              <div className="px-3 py-1 bg-black text-white text-xs font-medium tracking-widest uppercase">
                Al Marjan Island
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-6 relative z-50">
            ...
            <button
              ...
              className="tesla-btn-primary text-sm px-6 py-2"
            >
              Contact
            </button>
          </div>
