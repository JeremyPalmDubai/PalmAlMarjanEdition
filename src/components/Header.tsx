      ...
      <div className="tesla-container">
        <div className="flex items-center justify-between h-16 lg:h-18">
          <div className="flex items-center cursor-pointer" onClick={handleLogoClick}>
            ...
            <div className="ml-3 flex flex-col justify-center h-6 hidden md:flex">
            ...
            <div className="ml-3 md:ml-6 px-3 py-1 bg-black text-white rounded-full text-2xs font-medium tracking-widest hidden sm:block">
          ...
          <nav className="hidden xl:flex items-center space-x-6">
            <a href="#al-marjan-island" onClick={(e) => handleNavClick(e, 'al-marjan-island')} className="tesla-nav-item-enhanced">
              <span className="nav-text">Island</span>
            </a>
            <a href="#opportunity" onClick={(e) => handleNavClick(e, 'opportunity')} className="tesla-nav-item-enhanced">
              <span className="nav-text">{t.navigation.opportunity}</span>
            </a>
            <a href="#wynn-effect" onClick={(e) => handleNavClick(e, 'wynn-effect')} className="tesla-nav-item-enhanced">
              <span className="nav-text">{t.navigation.wynn}</span>
            </a>
            <a href="#roi-metrics" onClick={(e) => handleNavClick(e, 'roi-metrics')} className="tesla-nav-item-enhanced">
              <span className="nav-text">{t.navigation.roi}</span>
            </a>
            <a href="#developments" onClick={(e) => handleNavClick(e, 'developments')} className="tesla-nav-item-enhanced">
              <span className="nav-text">{t.navigation.developments}</span>
            </a>
            <a href="#lifestyle" onClick={(e) => handleNavClick(e, 'lifestyle')} className="tesla-nav-item-enhanced">
              <span className="nav-text">{t.navigation.lifestyle}</span>
            </a>
            <a href="#contact" onClick={(e) => handleNavClick(e, 'contact')} className="tesla-nav-item-enhanced tesla-nav-cta">
              <span className="nav-text">{t.navigation.contact}</span>
            </a>
          </nav>
          
          {/* Tablet Navigation - Compact */}
          <nav className="hidden lg:flex xl:hidden items-center space-x-4">
            <a href="#opportunity" onClick={(e) => handleNavClick(e, 'opportunity')} className="tesla-nav-item-compact">Invest</a>
            <a href="#wynn-effect" onClick={(e) => handleNavClick(e, 'wynn-effect')} className="tesla-nav-item-compact">Wynn</a>
            <a href="#roi-metrics" onClick={(e) => handleNavClick(e, 'roi-metrics')} className="tesla-nav-item-compact">ROI</a>
            <a href="#developments" onClick={(e) => handleNavClick(e, 'developments')} className="tesla-nav-item-compact">Projects</a>
            <a href="#contact" onClick={(e) => handleNavClick(e, 'contact')} className="tesla-nav-item-compact tesla-nav-cta-compact">Contact</a>
          </nav>
          ...
          <div className="flex items-center space-x-3">
            ...
            >
              <svg className={`w-5 h-5 text-gray-700 transition-transform duration-300 ${isMobileMenuOpen ? 'rotate-90' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                {isMobileMenuOpen ? (
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-md border-t border-gray-100 shadow-lg">
            <nav className="tesla-container py-4">
              <div className="grid grid-cols-2 gap-3">
                <a 
                  href="#al-marjan-island" 
                  onClick={(e) => {
                    handleNavClick(e, 'al-marjan-island');
                    setIsMobileMenuOpen(false);
                  }} 
                  className="tesla-mobile-nav-item"
                >
                ...
                >
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-black rounded-full mr-3"></div>
                    <span>{t.navigation.opportunity}</span>
                  </div>
                </a>
                <a 
                  href="#wynn-effect" 
                  onClick={(e) => {
                    handleNavClick(e, 'wynn-effect');
                    setIsMobileMenuOpen(false);
                  }} 
                  className="tesla-mobile-nav-item"
                >
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-black rounded-full mr-3"></div>
                    <span>{t.navigation.wynn}</span>
                  </div>
                </a>
                <a 
                  href="#roi-metrics" 
                  onClick={(e) => {
                    handleNavClick(e, 'roi-metrics');
                    setIsMobileMenuOpen(false);
                  }} 
                  className="tesla-mobile-nav-item"
                >
                ...
                >
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-black rounded-full mr-3"></div>
                    <span>{t.navigation.developments}</span>
                  </div>
                </a>
                <a 
                  href="#lifestyle" 
                  onClick={(e) => {
                    handleNavClick(e, 'lifestyle');
                    setIsMobileMenuOpen(false);
                  }} 
                  className="tesla-mobile-nav-item"
                >
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-black rounded-full mr-3"></div>
                    <span>{t.navigation.lifestyle}</span>
                  </div>
                </a>
              </div>
              ...
              <div className="mt-6 pt-4 border-t border-gray-200">
                <a 
                  ...
                  className="block w-full text-center bg-black text-white py-3 px-6 rounded-lg font-medium text-sm tracking-wide hover:bg-gray-800 transition-colors"
                >
