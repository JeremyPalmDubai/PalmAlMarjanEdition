      ...
      <div className="tesla-container">
        ...
        <div className="hidden sm:flex items-center justify-between h-16">
          <div className="flex items-center cursor-pointer" onClick={handleLogoClick}>
            ...
            <div className="ml-4 md:ml-6">
              <div className="px-4 py-2 bg-black text-white rounded-full text-xs font-medium tracking-wider">
        ...
        <div className="sm:hidden py-3 px-1">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center cursor-pointer" onClick={handleLogoClick}>
              ...
              <div className="ml-2 flex flex-col justify-center">
                <div className="text-black font-inter font-bold text-[9px] tracking-wider leading-tight uppercase">
                  Al Marjan Island
                </div>
              </div>
            </div>
          ...
          <a
            href="#contact"
            onClick={handleContactClick}
            className="bg-black text-white px-6 py-2.5 rounded-full font-semibold text-sm tracking-wide hover:bg-gray-800 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-black flex items-center justify-center w-full"
            aria-label="Contact us for investment opportunities"
          >
            <span className="text-center">{t.navigation.contact}</span>
          </a>
        </div>
      </div>
    </header>
