      ...
      <div className="tesla-container">
        <div className="flex items-center justify-between h-14 lg:h-16">
          <div className="flex items-center cursor-pointer" onClick={handleLogoClick}>
            ...
            <div className="ml-3 flex flex-col justify-center h-6 hidden sm:flex">
            ...
            <div className="ml-3 sm:ml-6 px-2 sm:px-3 py-1 bg-black text-white rounded-full text-2xs font-medium tracking-widest">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            <a href="#developments" onClick={(e) => handleNavClick(e, 'developments')} className="tesla-nav-item">{t.navigation.developments}</a>
            <a href="#lifestyle" onClick={(e) => handleNavClick(e, 'lifestyle')} className="tesla-nav-item">{t.navigation.lifestyle}</a>
            <a href="#contact" onClick={(e) => handleNavClick(e, 'contact')} className="tesla-nav-item">{t.navigation.contact}</a>
          </nav>
