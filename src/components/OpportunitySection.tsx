      ...
      <div className="tesla-container-tight">
        ...
        <div className="grid md:grid-cols-2 gap-16 lg:gap-24 mb-32">
          <div className="animate-slide-in">
            <div className="mb-6">
              <h3 className="text-2xl tesla-heading mb-4">{t.opportunity.features.strategic.title}</h3>
              <p className="tesla-subheading leading-relaxed">{t.opportunity.features.strategic.description}</p>
            </div>
          </div>
          <div className="animate-slide-in">
            <div className="mb-6">
              <h3 className="text-2xl tesla-heading mb-4">{t.opportunity.features.transformation.title}</h3>
              <p className="tesla-subheading leading-relaxed">{t.opportunity.features.transformation.description}</p>
            </div>
          </div>
          <div className="animate-slide-in">
            <div className="mb-6">
              <h3 className="text-2xl tesla-heading mb-4">{t.opportunity.features.infrastructure.title}</h3>
              <p className="tesla-subheading leading-relaxed">{t.opportunity.features.infrastructure.description}</p>
            </div>
          </div>
          <div className="animate-slide-in">
            <div className="mb-6">
              <h3 className="text-2xl tesla-heading mb-4">{t.opportunity.features.economy.title}</h3>
